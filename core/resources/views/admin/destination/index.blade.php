...
@section('body')
            ...
            <form role="form" method="POST" action="" name="editForm" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-10 offset-1">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" value="{{$basic->popular_destination_h}}" name="popular_destination_h">
                ...
                <div class="row">
                    <div class="col-md-10 offset-1">
                        <h5>Sub Title</h5>
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" value="{{$basic->popular_destination_p}}" name="popular_destination_p">
                            <div class="input-group-append"><span class="input-group-text"><i class="fa fa-font"></i></span></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card" style="margin-top: 20px">
        ...
        <div class="card-header bg-white font-weight-bold">
            ...
            <a href="{{route('destination.create')}}" class="btn btn-success btn-md float-right ">
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    @foreach($posts as $k=>$data)
                        <tr>
                            ...
                            <td data-label="Image">
                                <img style="width: 120px" src="{{ asset('assets/images/tour') }}/{{ $data->image }}" alt="...">
                            </td>
                            ...
                            <td data-label="Action">
                                <a class=" btn btn-info btn-sm"
                                   href="{{route('destination.edit',$data->id)}}"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="{{ route('destination.delete') }}" >
                        {!! csrf_field() !!}
                        {{ method_field('DELETE') }}
