...
@section('body')
    ...
    <div class="card mb-4">
        ...
        <form role="form" method="POST" action="{{route('agent.store')}}" name="editForm" enctype="multipart/form-data">
            {{ csrf_field() }}
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="company_name" value="{{old('company_name')}}"
                               class="form-control form-control-lg @if ($errors->has('company_name')) is-invalid @endif"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="city" value="{{old('city')}}"
                               class="form-control form-control-lg @if ($errors->has('city')) is-invalid @endif"
                               placeholder="City">
                        @if ($errors->has('city'))
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="country" class="form-control" style="width: 100%" data-live-search="true">
