...
@section('body')
            ...
            <form role="form" method="POST" action="" name="editForm" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-10 offset-1">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" value="{{$basic->popular_tour_h}}" name="popular_tour_h">
                ...
                <div class="row">
                    <div class="col-md-10 offset-1">
                        <h5>Sub Title</h5>
                        <div class="input-group">
                            <input type="text" class="form-control form-control-lg" value="{{$basic->popular_tour_p}}" name="popular_tour_p">
                            <div class="input-group-append"><span class="input-group-text"><i class="fa fa-font"></i></span></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card" style="margin-top: 20px">
        ...
        <div class="card-header bg-white font-weight-bold">
            ...
            <a href="{{route('tour.create')}}" class="btn btn-success btn-md float-right ">
                <i class="fa fa-plus"></i> Add New Tour
            </a>
        </div>
                        ...
                        <tr>
                            ...
                            <td data-label="Action">
                                <a class=" btn btn-info btn-sm"
                                   href="{{route('tour.edit',$data->id)}}"><i
