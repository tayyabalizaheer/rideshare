...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDygYvsPmW7qvJQrqmZrxr_ezdaZ0LjZr4&callback=initMap&libraries=&v=weekly" defer></script>
    ...
    <div class="card mb-4">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8">
                <form role="form" method="POST" action="{{route('manage-location.update',$location)}}" name="editForm"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <input id="address" type="text" name="name" placeholder="Location Name" value="{{$location->name}}"
                            ...
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <input id="lat" type="text" name="latitude" placeholder="latitude " value="{{$location->lat}}"
                                       class="form-control form-control-lg @if ($errors->has('latitude'))  is-invalid @endif">
                            </div>

                            <div class="offset-md-1 col-md-9 mb-3">
                                <label><strong>Longitude</strong></label>
                                <input id="lan" type="text" name="longitude" placeholder="longitude" value="{{$location->lan}}"
                                        ...
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;" data-trigger="fileinput">
                                            ...
                                            @if($location->image == null)
                                                <img style="width: 200px"
                                                     ...
                                                     alt="...">
                                            @else
                                                <img style="width: 200px" src="{{ asset('assets/images/trip') }}/{{ $location->image }}" alt="...">
                                            @endif
                        ...
                        <div class="form-row">
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <input type="checkbox" name="status" @if($location->status == 1) checked @endif data-toggle="toggle" data-on="Active" data-off="DeActive"
