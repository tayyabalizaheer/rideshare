...
<script
  src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDygYvsPmW7qvJQrqmZrxr_ezdaZ0LjZr4&libraries=&v=weekly"
></script>
@section('driver')
                        ...
                        <div class="form-row">
                            ...
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <select id="start-point"  name="start_point"
                                    ...
                                    @endforeach
                                    <input type="text" id="s-p-lat" name="s-p-lat" hidden="hidden" value="{{$startroute->lat}}">
                                    <input type="text" id="s-p-lan" name="s-p-lan" hidden="hidden" value="{{$startroute->lan}}">
                                </select>
                            ...
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <select id="end-point" name="end_point"
                                    ...
                                    @endforeach
                                    <input type="text" id="e-p-lat" name="e-p-lat" hidden="hidden" value="{{$endroute->lat}}">
                                    <input type="text" id="e-p-lan" name="e-p-lan" hidden="hidden" value="{{$endroute->lan}}">
                                </select>
                            ...
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <input id="distance" type="text" name="distance" placeholder="Distance" value="{{$route->distance}}"
                            ...
                            <div class="offset-md-1 col-md-9 mb-3">
                                ...
                                <div class="input-group mb-3">
                                    <input id="price_per_kilo" type="text" name="price" placeholder="Distance" value="{{$route->price}}"
