...
@section('body')
    ...
    <div class="card mb-4">
        ...
        <form role="form" method="POST" action="{{route('agent.trip-assign.update',$tripAssign)}}" name="editForm"
                ...
                <div class="form-row">
                    ...
                    <div class="offset-md-1 col-md-9 mb-3">
                        ...
                        <input name="end_date" class="form-control form-control-lg datetimepicker" type="text"
                               placeholder="Trip End Date" id="end_date" value="{{$tripAssign->end_date}}" disabled>
                    </div>
                ...
                <div class="form-row">
                    <div class="offset-md-1 col-md-9 mb-3">
                        ...
                        <input type="checkbox" name="status" data-toggle="toggle" data-on="Active" data-off="DeActive"
                              @if($tripAssign->status == 1) checked @endif data-onstyle="success" data-offstyle="danger" data-width="100%" disabled>
                    </div>
                </div>
