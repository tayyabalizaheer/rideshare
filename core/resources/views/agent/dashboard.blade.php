...
@section('body')
    ...
    <div class="row mb-4">
        <div class="col-md">
            <a href="javascript:void(0)" class="textDecoration">
                <div class="d-flex border">
                    ...
                    <div class="flex-grow-1 bg-white p-4">
                        ...
                        <h3 class="font-weight-bold mb-0">{{$balance}}</h3>
                    </div>
                </div>
            </a>
        </div>
        ...
        <div class="col-md">
            <a href="javascript:void(0)" class="textDecoration">
                <div class="d-flex border">
                    ...
                    <div class="flex-grow-1 bg-white p-4">
                        <p class="text-uppercase text-secondary mb-0">Ticket Selling Commission</p>
                        <h3 class="font-weight-bold mb-0">{{$soldProfit}}</h3>
                    </div>
                </div>
            </a>
        </div>
        <div class="col-md">
            <a href="#" class="textDecoration">
                <div class="d-flex border">
                    ...
                    <div class="flex-grow-1 bg-white p-4">
                        <p class="text-uppercase text-secondary mb-0">Total Deposit</p>
