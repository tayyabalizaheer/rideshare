    ...
    <div class="card">
        ...
        <div class="card-header bg-white font-weight-bold">
            <form action="{{route('agent.tripSearch')}}" method="get">
                <div class="form-row">
                    <div class="col-lg-3">
                        <input type="text" name="start_point" value="@isset($start_point) {{$start_point}} @endisset " class="form-control form-control-lg"
                               id="fromAutoComplete" placeholder="From">
                    </div>
                    <div class="col-lg-3">
                        <input type="text" name="end_point"  value="@isset($end_point) {{$end_point}}@endisset" id="toAutoComplete" class="form-control form-control-lg"
                               placeholder="To">
                    </div>
                    <div class="col-lg-3">


                        <input type="text" name="date" id="datetimepicker2"  value="@isset($startDate) {{ date('d M Y',strtotime($startDate))}} @else {{ old('date')}} @endisset" class="form-control form-control-lg"
                               placeholder="Date">
                    </div>

                    <div class="col-lg-3">
                        <button type="submit"
                                class="btn btn-success btn-lg  h-serch mamunur_rashid_form_sm">
