...
<div id="refr">
    <table  style="display: none"  id="layoutimg"></table>
</div>
            ...
            $("#layoutimg").append(function(){
                ...
                $.each(options, function(val) {
                    ...
                    $container.append($("<tr/>").append(
                        $("<td/>").html("<img class='img' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' title='"+char+1+"' />"),
                        $("<td/>").html("<img class='img' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' title='"+char+2+"'/>"),
                        $("<td/>").html("<div class='"+lastclass+"' title='"+char+"M'></div>"),
                        $("<td/>").html("<img class='img' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}'  title='"+char+3+"'/>"),
                        $("<td/>").html("<img class='img' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}'  title='"+char+4+"'/>"),
            ...
            $("#layoutimg").append(function(){
                ...
                $.each(options, function(val) {
                    ...
                    $container.append($("<tr/>").append(
                        ...
                        $("<td/>").html("<div class='"+lastclass+"' title='"+char+"M'></div>"),
                        $("<td/>").html("<img class='img' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' title='"+char+3+"'/>"),
            ...
            $("#layoutimg").append(function(){
                ...
                $.each(options, function(val) {
                    ...
                    $container.append($("<tr/>").append(
                        ...
                        $("<td/>").html("<img class='img' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' title='"+char+4+"'/>"),
                        $("<td/>").html("<img class='img' width='50px' height='50px' src='{{asset("assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' onerror=this.src='{{asset("../assets/images/f2dcc1cda37a23d4dd30125ebf2ac6ae.png")}}' title='"+char+5+"'/>"),
